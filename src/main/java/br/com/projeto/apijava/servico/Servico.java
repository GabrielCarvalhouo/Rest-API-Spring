package br.com.projeto.apijava.servico;
...
import br.com.projeto.apijava.modelo.Mensagem;
...
public class Servico {
    ...
    public ResponseEntity<?> selecionarPeloCodigo(int codigo) {
        ...
        if (acao.countByCodigo(codigo) == 0) {
            mensagem.setMensagem("Não foi encontrada nenhuma pessoa com este código na nossa base de dados...");
            return new ResponseEntity<>(mensagem, HttpStatus.BAD_REQUEST);
        } else {
